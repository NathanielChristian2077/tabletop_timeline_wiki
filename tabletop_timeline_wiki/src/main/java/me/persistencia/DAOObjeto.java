...
public class DAOObjeto {
    ...
    public Objeto buscarPorId(String id, Connection conn, Map<String, Associavel> visitados) throws SQLException {
        if (visitados.containsKey(id)) return (Objeto) visitados.get(id);
